...
const HeroMain = () => {
  ...
  return (
    <>
      ...
      {/* About Section Start */}
      <div>
        <div className="relative md:h-screen w-full gap-4 flex justify-center items-center flex-col overflow-hidden">
      ...
      <div>
        <div className="relative md:h-screen w-full gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
          <div className="z-0 mb-48 md:mb-0  md:absolute top-1/4  md:right-[10%] md:-translate-y-16 ">
          ...
          <div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 py-5">
            ...
            <motion.p
              className="title  text-xl mt-4 tracking-wider text-gray-550 leading-[1.7rem] mb-5"
              initial={{ x: -100, opacity: 0 }}
              whileInView={{ x: 0, opacity: 1 }}
              transition={{
                delay: 0.2,
        ...
        <div className="relative md:h-screen w-full  gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
          ...
          <div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 overflow-hidden">
            ...
            {settings.contactEmail && (
              <motion.p
                className="title text-xl mt-4 tracking-wider text-gray-500 leading-[1.7rem] mb-2"
                initial={{ x: -100, opacity: 0 }}
                whileInView={{ x: 0, opacity: 1 }}
                transition={{
                  delay: 0.3,
            ...
            {settings.contactPhone && (
              <motion.p
                className="title text-xl mt-2 tracking-wider text-gray-500 leading-[1.7rem] mb-5"
                initial={{ x: -100, opacity: 0 }}
                whileInView={{ x: 0, opacity: 1 }}
                transition={{
                  delay: 0.35,
