    ...
    return (
        <div className='w-full h-[64px] bg-white border-b border-gray-200 z-[60] fixed top-0 flex items-center justify-between px-[30px] shadow-sm'>
            <div className='flex items-center gap-[10px] cursor-pointer' onClick={() => navigate("/")}>
                <span className='text-2xl font-black text-black tracking-tight uppercase'>Portfolio</span>
                <span className='text-[11px] font-semibold text-gray-400 uppercase tracking-widest bg-gray-100 px-2 py-1 rounded-full'>Dev Admin</span>
            </div>
            <button
                onClick={logOut}
